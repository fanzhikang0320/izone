...
export default {
    ...
    mounted() {
        this.locationAccount = sessionStorageUtil.getSessionStorage('searchKey');
    ...
    beforeDestroy() { 
        document.getElementsByTagName('body')[0].onscroll =false;
        this.$store.commit('changeData',[]);
        this.$store.commit('changeLoading',true);
        this.$store.commit('changeShowNull',false);

        sessionStorageUtil.deleteSessionStorage('searchKey')
    }
